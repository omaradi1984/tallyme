...
public class Log implements Attachable {
	...
	public static final class Builder implements LogBuilder {
		private String name;
		private String description;
		private Date date;
		private UUID uuid;
		...
		@Override
		public LogBuilder withUuid(UUID uuid) {
			this.uuid = uuid;
			return this;
		}

		@Override
		public LogBuilder withCode(String code) {
			this.code = code;
			return this;
		}

		@Override
		public LogBuilder withAttachment(File attachment) {
			this.attachment = attachment;
			return this;
		}
